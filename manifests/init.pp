...
class one (
  ...
  Stdlib::IP::Address $oned_listen_address      = '0.0.0.0',
  ...
  Optional[String[1]] $ldap_group               = undef,
  Optional[String[1]] $ldap_user_field          = undef,
  Optional[String[1]] $ldap_group_field         = undef,
  Optional[String[1]] $ldap_user_group_field    = undef,
  ...
  Hash $ldap_mappings                           = {},
  Optional[String[1]] $ldap_mapping_key         = undef,
  Optional[String[1]] $ldap_mapping_default     = undef,
  ...
  Stdlib::IP::Address $sunstone_listen_ip       = '127.0.0.1',
  Optional[String[1]] $sunstone_logo_png        = undef,
  Optional[String[1]] $sunstone_logo_small_png  = undef,
  ...
  Optional[String[1]] $sunstone_vnc_proxy_cert  = undef,
  Optional[String[1]] $sunstone_vnc_proxy_key   = undef,
  ...
  Optional[String[1]] $sched_default_ds_rank    = undef,
